...
@section('title', 'User Created Transactions')
    ...
    <div class="d-flex align-items-center mb-3">
        <div>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">USER CREATED TRANSACTIONS</li>
            </ol>
            <h1 class="page-header mb-0">User Created Transactions</h1>
        </div>
        <div class="ms-auto">
